...
| [1. What is state ?]({% post_url 2015-12-04-on-stateless-software-design-what-is-state %}) | [2. State and correctness]({% post_url 2015-12-05-on-stateless-software-design-state-and-correctness %}) | 3. State and scalability | [4. State and performance]({% post_url 2015-12-07-on-stateless-software-design-state-and-performance %}) | [5. Conclusion]({% post_url 2015-12-08-on-stateless-software-design-conclusion %})
...
| [2. State and correctness]({% post_url 2015-12-05-on-stateless-software-design-state-and-correctness %}) | &#171; | 3. State and scalability | &#187; | [4. State and performance]({% post_url 2015-12-07-on-stateless-software-design-state-and-performance %}) |
